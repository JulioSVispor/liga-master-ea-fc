          ...
          <div className="p-5 rounded-xl bg-gradient-to-br from-white/[0.02] to-white/[0.05] border border-gray-800 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-start gap-4">
                {news[0].badge_url && <img src={news[0].badge_url} alt="" className="w-12 h-12 object-contain bg-[#060913] rounded-lg p-1.5 border border-gray-800 flex-shrink-0" />}
                {news[0].player_face_url && !news[0].badge_url && <img src={news[0].player_face_url} alt="" className="w-12 h-12 object-cover bg-[#060913] rounded-full border border-gray-800 flex-shrink-0" />}
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1 scrollbar-thin">
              ...
              {news.slice(1).map((item) => (
                <div key={item.id} className="p-3 rounded-lg border border-gray-800/50 bg-[#060913] hover:border-gray-700 transition-colors flex items-start gap-3">
                  {item.badge_url ? <img src={item.badge_url} alt="" className="w-8 h-8 object-contain bg-black/20 rounded p-1 border border-gray-800 flex-shrink-0" />
                  : item.player_face_url ? <img src={item.player_face_url} alt="" className="w-8 h-8 object-cover bg-black/20 rounded-full border border-gray-800 flex-shrink-0" />
