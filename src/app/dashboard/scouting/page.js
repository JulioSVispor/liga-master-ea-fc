...
export default function Scouting() {
  ...
  const handleBuyout = (player) => {
    ...
    setConfirmModal({
      ...
      message: `Deseja pagar a Multa Rescisória de ${player.name} no valor de R$ ${buyoutPrice.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}?\n\nO jogador será transferido instantaneamente para seu time sem necessidade de aprovação do outro técnico!`,
      onConfirm: async () => {
        setActionLoading(player.id);
        try {
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 hover:border-white/20 bg-white/[0.03] py-2.5 px-4 text-white text-sm focus:ring-2 focus:ring-[#10b981]/30 focus:border-[#10b981] outline-none transition-all duration-200"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-white/10 hover:border-white/20 bg-[#090d16] py-2.5 px-4 text-white text-sm focus:ring-2 focus:ring-[#10b981]/30 focus:border-[#10b981] outline-none transition-all duration-200 cursor-pointer"
            >
              {positions.map((pos) => (
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-1/2 rounded-xl border border-white/10 hover:border-white/20 bg-white/[0.03] py-2.5 px-3 text-center text-white text-sm focus:ring-2 focus:ring-[#10b981]/30 focus:border-[#10b981] outline-none transition-all duration-200"
                placeholder="Mín"
              />
              <input
                type="number"
                ...
                {players.map((player) => {
                  ...
                  return (
                    <tr key={player.id} className="hover:bg-white/[0.01] transition-colors group">
                      ...
                      <td className="py-3 px-4 text-center">
                        {isFree ? (
                          <span className="inline-block rounded-full bg-emerald-500/10 border border-emerald-500/30 px-2.5 py-0.5 text-[9px] font-bold text-[#10b981]">
                            🟢 Livre
                          </span>
                        ) : isMine ? (
                          <span className="inline-block rounded-full bg-blue-500/10 border border-blue-500/30 px-2.5 py-0.5 text-[9px] font-bold text-[#3b82f6]">
                            🛡️ Meu Time
                          </span>
                        ) : (
                          <span className="inline-block rounded-full bg-amber-500/10 border border-amber-500/35 px-2.5 py-0.5 text-[9px] font-bold text-amber-500 truncate max-w-[130px]" title={player.teams?.name}>
                            🏃‍♂️ {player.teams?.name || "Ocupado"}
                          </span>
                        )}
                      </td>
                          ...
                          {isFree ? (
                            ...
                            <div className="flex items-center gap-1.5 justify-center w-full">
                              ...
                              <button
                                ...
                                disabled={actionLoading !== null}
                                className="rounded-xl bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 px-3 py-2 text-[10px] font-bold text-white shadow-sm transition-all hover:scale-[1.02] flex items-center justify-center gap-1 disabled:opacity-50 flex-shrink-0"
                              ...
                              <button
                                ...
                                className="rounded-xl bg-[#3b82f6]/10 hover:bg-[#3b82f6]/20 border border-[#3b82f6]/20 px-3 py-2 text-[10px] font-bold text-[#3b82f6] transition-all text-center flex items-center justify-center gap-0.5 flex-shrink-0"
                              ...
                              <button
                                ...
                                className="rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2 text-[10px] font-bold text-white transition-all text-center flex items-center justify-center gap-0.5 flex-shrink-0"
      ...
      {showLoanModal && selectedLoanPlayer && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 animate-fadeIn">
